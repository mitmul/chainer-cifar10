...
class VGGNet(FunctionSet):
    ...
    def __init__(self):
        super(VGGNet, self).__init__(
            ...
            bn9=F.BatchNormalization(1024),
            fc10=F.Linear(1024, 1024),
            bn10=F.BatchNormalization(1024),
    ...
    def forward(self, x_data, y_data, train=True):
        ...
        h = F.dropout(F.relu(self.bn9(self.fc9(h))), train=train, ratio=0.5)
        h = F.dropout(F.relu(self.bn10(self.fc10(h))), train=train, ratio=0.5)
        h = self.fc11(h)
